  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <motion.div variants={fadeIn('right','tween',0.2,1)} className="flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative">
        ...
        <div>
          <h4 className="font-bold sm:text-[32px] text-[26px] sm:leading-[40px] leading-[36px] text-white">Sariq</h4>
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white">Founder | Metaversus</p>
        </div>
        <p className="mt-[24px] font-normal sm:text-[24px] text-[12px] sm:leading-[45px] leading-[39px] text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad veritatis perspiciatis laboriosam voluptatem! Hic aperiam impedit praesentium, quas nam consectetur ex ipsum autem. Quae, molestiae dolorem. Voluptates cumque alias aspernatur?</p>
      </motion.div>
